    ...
    def get_args():
        parser = argparse.ArgumentParser('MVD fine-tuning and evaluation script for video classification',
                                         add_help=False)
    ...
    def main(args, ds_init):
        ...
        # MVD finetuning
        wandb.init(project='testing zero shot', name=run_name)
        ...
        if args.finetune == 's3d':
            ...
            args.window_size = (
            args.num_frames // 2, args.input_size // patch_size[0], args.input_size // patch_size[1])
        ...
        if args.eval:
            ...
            if global_rank == 0:
                ...
                if args.output_dir and utils.is_main_process():
                    with open(os.path.join(args.output_dir, args.eval_log_name + ".txt"), mode="a",
                              encoding="utf-8") as f:
